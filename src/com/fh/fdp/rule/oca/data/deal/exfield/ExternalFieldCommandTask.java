 ...
 * @author dhl
 */
public class ExternalFieldCommandTask extends ExternalFieldCommand {
	...
	public List<String> externalFields() {
		return Arrays.asList("createtime", "updatetime", "collect_status", "collect_count", "source", "rule_type");// create_time
	}
